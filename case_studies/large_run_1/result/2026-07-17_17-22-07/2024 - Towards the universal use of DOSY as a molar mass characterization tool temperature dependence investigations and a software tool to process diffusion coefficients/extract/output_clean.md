...
† Electronic supplementary information (ESI) available: Experimental details, density calculations and SANS data fitting procedures. See DOI:
...
Igor W. F. Silva, a Alasdair McKay, b Anna Sokolova c and Tanja Junkers *
...
The software is published as a stand-alone executable file, and is available in the ESI, † or from the PRD group github account:
